  ...
  useEffect(() => {
    if (loadedData.length > 3) {
      if (!isPlaying) {
        ...
        startPlay && videoRef.current[videoId].play(); // Corrected this line
      }
    }
  ...
  const handleProcess = (type, i) => {
    switch (type) {
      ...
      case 'video-reset':
        ...
        break;
      case 'play':
        setVideo((prev) => ({ ...prev, isPlaying: !isPlaying }));
        break;
        case 'pause':
        setVideo((prev) => ({ ...prev, isPlaying: !isPlaying }));
        break;
  ...
  return (
    <>
      ...
      <div className="relative flex-center mt-10">
        ...
        <button className="control-btn" onClick={isLastVideo ? () => handleProcess('video-reset') : () => handleProcess(isPlaying ? 'pause' : 'play')}>
